...
module StorageConcern
  ...
  def image_unique_id(user_id, directory_id, file_name)
    format('%{user_id}/%{directory_id}/%{file_name}', user_id: user_id, directory_id: directory_id, file_name: file_name)
  end

  def directory_image_id(user_id, parent_directory_id, directory_name)
    format('%{user_id}/%{parent_directory_id}/%{directory_name}', user_id: user_id, parent_directory_id: parent_directory_id, directory_name: directory_name)
  end
